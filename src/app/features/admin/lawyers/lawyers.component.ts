...
import { DashboardStats, Lawyer, LawyersService } from '../../../core/services/admin/lawyers.service';
...
export class LawyersComponent implements OnInit {
  ...
  showDetailLawyer(lawyerId: String) {
    console.log(lawyerId)
    this.showLawyerInfo = !this.showLawyerInfo
  }
